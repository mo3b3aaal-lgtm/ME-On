...
export const AuthView: React.FC<AuthViewProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto android-scrollbar flex flex-col justify-between min-h-full bg-[#17163D] text-white select-none relative" dir="rtl">
      ...
      <div className="relative z-10 pt-6 pb-2 px-5 text-center flex flex-col items-center">
        ...
        <h1 className="text-2xl font-black tracking-tight text-white flex items-center gap-1.5 justify-center">
          ...
          <span className="text-[#FF647C]">كلاسي</span>
        </h1>
        ...
        <div className="space-y-4">
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-3.5 text-xs">
              <div>
                <label className="block font-bold text-[#17163D] mb-1.5">البريد الإلكتروني / الهاتف / الاسم</label>
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-3 pr-10 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6] focus:ring-2 focus:ring-[#7657F6]/20 transition-all placeholder:text-[#9A9CB8]"
                  />
                  <Mail className="w-4 h-4 text-[#7657F6] absolute right-3.5 top-3.5" />
                </div>
              </div>

              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="font-bold text-[#17163D]">كلمة المرور</label>
                  <button
                    type="button"
                    onClick={() => {
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-3 pr-10 pl-10 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6] focus:ring-2 focus:ring-[#7657F6]/20 transition-all placeholder:text-[#9A9CB8]"
                  />
                  <Lock className="w-4 h-4 text-[#7657F6] absolute right-3.5 top-3.5" />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute left-3.5 top-3.5 text-[#9A9CB8] hover:text-[#17163D] cursor-pointer"
                  >
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegister} className="space-y-3 text-xs">
              <div>
                <label className="block font-bold text-[#17163D] mb-1">اسم المعلم بالكامل *</label>
                <div className="relative">
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-9 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                  />
                  <User className="w-4 h-4 text-[#7657F6] absolute right-3 top-3" />
                </div>
              </div>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold text-[#17163D] mb-1">المادة الأساسية *</label>
                  <div className="relative">
                    <input
                      type="text"
                      required
                      ...
                      className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-8 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                    />
                    <BookOpen className="w-3.5 h-3.5 text-[#7657F6] absolute right-2.5 top-3" />
                  </div>
                </div>

                <div>
                  <label className="block font-bold text-[#17163D] mb-1">رقم الهاتف</label>
                  <div className="relative">
                    <input
                      type="tel"
                      value={regPhone}
                      ...
                      className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-8 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                    />
                    <Phone className="w-3.5 h-3.5 text-[#7657F6] absolute right-2.5 top-3" />
                  </div>
                </div>
              </div>

              <div>
                <label className="block font-bold text-[#17163D] mb-1">البريد الإلكتروني / اسم المستخدم *</label>
                <div className="relative">
                  <input
                    type="email"
                    required
                    ...
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-9 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                  />
                  <Mail className="w-4 h-4 text-[#7657F6] absolute right-3 top-3" />
                </div>
              </div>

              <div>
                <label className="block font-bold text-[#17163D] mb-1">اسم السنتر / المدرسة</label>
                <div className="relative">
                  <input
                    type="text"
                    value={regCenter}
                    ...
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-9 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                  />
                  <Building className="w-4 h-4 text-[#7657F6] absolute right-3 top-3" />
                </div>
              </div>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold text-[#17163D] mb-1">كلمة المرور *</label>
                  <input
                    type="password"
                    required
                    value={regPassword}
                ...
                <div>
                  <label className="block font-bold text-[#17163D] mb-1">تأكيد المرور *</label>
                  <input
                    type="password"
                    required
              ...
              <div>
                <label className="block font-bold text-[#17163D] mb-1 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-[#74778F]">لاسترجاع الحساب عند النسيان</span>
                </label>
                <div className="relative">
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#F6F7FC] border border-[#E8E7FF] rounded-2xl p-2.5 pr-9 text-xs text-[#17163D] font-semibold focus:outline-none focus:border-[#7657F6]"
                  />
                  <KeyRound className="w-4 h-4 text-[#FF647C] absolute right-3 top-3" />
                </div>
              </div>
          ...
          {mode === 'forgot_password' && (
            <form onSubmit={handleResetPassword} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-[#17163D] mb-1">البريد الإلكتروني أو الهاتف</label>
                <div className="relative">
                  <input
                    type="text"
                    required
              ...
              <div>
                <label className="block font-bold text-[#17163D] mb-1">كود الاستعادة السري (PIN)</label>
                <div className="relative">
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold text-[#17163D] mb-1">كلمة المرور الجديدة</label>
                  <input
                    type="password"
                    required
                ...
                <div>
                  <label className="block font-bold text-[#17163D] mb-1">تأكيد الجديدة</label>
                  <input
                    type="password"
                    required
