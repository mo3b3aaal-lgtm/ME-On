...
export const ClassyOwlMascot: React.FC<ClassyOwlMascotProps> = ({
  ...
  return (
    <div className={`relative inline-flex items-center justify-center select-none ${sizeMap[size]} ${className}`}>
      ...
      {glow && (
        <div className="absolute inset-0 bg-gradient-to-tr from-[#7B61FF]/30 via-[#FF5E62]/25 to-[#38B6FF]/25 rounded-full blur-xl transform scale-125 pointer-events-none -z-10 animate-pulse" />
      )}
      ...
      <svg
        ...
        className="w-full h-full filter drop-shadow-[0_8px_16px_rgba(30,31,61,0.15)]"
      >
        <defs>
          {/* Owl Body Gradient - Indigo / Violet */}
          <linearGradient id="owlBodyGrad" x1="40" y1="20" x2="160" y2="180" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#8A70FF" />
            <stop offset="50%" stopColor="#6C5CE7" />
            <stop offset="100%" stopColor="#4A3EC7" />
          </linearGradient>
          ...
          <linearGradient id="owlBellyGrad" x1="100" y1="90" x2="100" y2="175" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="60%" stopColor="#F5EDFF" />
            <stop offset="100%" stopColor="#E9DEFC" />
          </linearGradient>
          ...
          <linearGradient id="capGrad" x1="50" y1="10" x2="150" y2="50" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#252646" />
            <stop offset="100%" stopColor="#15162B" />
          </linearGradient>

          {/* Floating Sparkle Gradient */}
          <linearGradient id="sparkleGrad" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#FFAA2C" />
            <stop offset="100%" stopColor="#FF5E62" />
          </linearGradient>
        </defs>
        ...
        {/* Bridge */}
        <path d="M100 83 Q100 80 100 83" stroke="url(#owlCoralGrad)" strokeWidth="3.5" strokeLinecap="round" />
